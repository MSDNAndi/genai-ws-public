...
researcher = chatClient.AsAIAgent(name: "researcher", tools: [.. docsTools],
...
writer = chatClient.AsAIAgent(name: "writer",
    instructions: "You write replies to Kestrel customers: friendly, at most 80 words, only facts from the researcher's " +
                  "notes, no chunk ids in the text.");
// <<< TODO
