// STARTER - complete the TODO block(s). The finished version is in solution/03_workflow.mjs
...
try {
  ...
  throw new Error("TODO 1: create the researcher (uses the docs tools, returns cited facts only) and the writer (turns the facts into a friendly 80-word reply)");
