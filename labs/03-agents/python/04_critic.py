# STARTER - complete the TODO block(s). The finished version is in solution/04_critic.py
...
def next_speaker(state) -> str:
    ...
    raise NotImplementedError("TODO 2: return who speaks next - round 0 the researcher, then writer and critic take turns")
