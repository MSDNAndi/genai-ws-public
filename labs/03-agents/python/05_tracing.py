# STARTER - complete the TODO block(s). The finished version is in solution/05_tracing.py
...
raise NotImplementedError("TODO 3: switch tracing on with our exporter (and sensitive data, so tool arguments show up)")
