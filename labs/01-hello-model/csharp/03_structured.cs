...
// STARTER - complete the TODO block(s). The finished version is in solution/03_structured.cs
...
throw new NotImplementedException("TODO 1: ask for a Session - client.GetResponseAsync<Session>(messages, json, options) turns the record at the bottom into a JSON Schema and parses the reply into it");
