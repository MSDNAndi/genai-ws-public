...
// STARTER - complete the TODO block(s). The finished version is in solution/04_tool_loop.cs
...
for (; step < Budget; step++)
{
    ...
    throw new NotImplementedException("TODO 2: append the assistant message; if it has no ToolCalls print the answer and stop; otherwise run each tool and append a ToolChatMessage per call");
}
