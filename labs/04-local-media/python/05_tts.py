# STARTER - complete the TODO block(s). The finished version is in solution/05_tts.py
...
raise NotImplementedError("TODO 1: request speech for `text` with a voice (e.g. 'alloy' or os.getenv('TTS_VOICE')) as WAV and save it to out/welcome.wav")
